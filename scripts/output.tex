\hfill\textmd{h-index: 12, citations: 501}
\begin{footnotesize}
...
\begin{etaremune}[topsep=0pt,itemsep=0pt,partopsep=0pt,parsep=0pt]
    ...
    \pubitem{https://ui.adsabs.harvard.edu/abs/2025ApJ...986..111L}
    ...
    \pubitem{https://ui.adsabs.harvard.edu/abs/2021ApJ...922..136L}
            {Constraining Cosmic Microwave Background Temperature Evolution With Sunyaev-Zel\&\#x27;Dovich Galaxy Clusters from the Atacama Cosmology Telescope}
...
\begin{etaremune}[topsep=0pt,itemsep=0pt,partopsep=0pt,parsep=0pt]
    ...
    \pubitem{https://ui.adsabs.harvard.edu/abs/2025PhRvD.112l3520Z}
            {SPT-3G D1: Constraints on inflationary gravitational waves with two years of SPT-3G data}
            {Zebrowski, J. A.; Reichardt, C. L. \& \textbf{SPT-3G Collaboration}}
            {PhRvD 112, 123520 (2025)}
    
    \pubitem{https://ui.adsabs.harvard.edu/abs/2025arXiv251024669V}
            {Towards constraining cosmological parameters with SPT-3G observations of 25\% of the sky}
            {Vitrier, A.; Fichman, K.; Balkenhol, L.; Camphuis, E.; Guidi, F. \& \textbf{SPT-3G Collaboration}}
            {arXiv 2510.24669 (2025)}
    
    \pubitem{https://ui.adsabs.harvard.edu/abs/2025ApJS..279...30C}
            ...
            {Coppi, Gabriele; Dachlythra, Nadia; Nati, Federico; Dünner-Planella, Rolando; Adler, Alexandre E.; Errard, Josquin; Galitzki, Nicholas; \textbf{YL}; Petroff, Matthew A.; Simon, Sara M.; Sang, Ema Tsang King; Aguilar, Amalia Villarrubia; Wollack, Edward J. \& Zannoni, Mario}
            {ApJS 279, 30 (2025)}
    
    \pubitem{https://ui.adsabs.harvard.edu/abs/2025ApJS..278...56N}
